	...
	$("#subscribe").click(function(){
		if(${sessionScope.userid==null}){
			...
			if(confirm("장바구니에 추가하시겠습니까?")){
				...
				$.ajax({
					type : "post",
					url  : "/Tutoring/class/favoriteCheck",
...
<!-- 강의 소개 -->
	...
	<div class="card">
		<form action="/Tutoring/class/favoriteInsert" method="post" id="frm">
		 	<!-- 등록하고자 하는 강의 번호 -->
