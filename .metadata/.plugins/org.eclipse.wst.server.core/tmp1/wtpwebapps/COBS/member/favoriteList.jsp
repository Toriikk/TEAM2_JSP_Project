...
$(document).ready(function(){
	//장바구니 리스트를 불러옴
	$.getJSON("/Tutoring/member/favoriteList", 
				{userid:$("#userid").val()}, 
				function(d){
...
//장바구니 삭제함수
function favoritedel(favoritenum){
	if(confirm("장바구니에서 삭제하시겠습니까?")){
		$.getJSON("/Tutoring/member/favoriteDelete", 
				{"favoritenum":favoritenum, userid:$("#userid").val()}, 
				function(d){
						var htmlStr="<table class='table table-hover table-bordered table-sm'>";
						htmlStr+="<thead><tr>";
		            	htmlStr+="<th style='width: 10%; text-align: center;'>강의 번호</th>";
...
<aside class="sidebar">
	<ul id="menu">
        <li><h5><a href="/Tutoring/member/favoriteList.jsp"> 장바구니</a></h5></li>
...
<form action="/Tutoring/member/favoriteList">
