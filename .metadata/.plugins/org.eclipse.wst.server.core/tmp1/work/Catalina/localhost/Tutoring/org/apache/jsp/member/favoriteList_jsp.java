 ...
 * Generated at: 2022-07-25 09:21:50 UTC
...
public final class favoriteList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	//장바구니 리스트를 불러옴\n");
      out.write("	$.getJSON(\"/Tutoring/member/favoriteList\", \n");
      out.write("				{userid:$(\"#userid\").val()}, \n");
      out.write("				function(d){\n");
      out.write("					var htmlStr=\"<table class='table table-hover table-bordered table-sm'>\";\n");
      out.write("						htmlStr+=\"<thead><tr>\";\n");
      out.write("		            	htmlStr+=\"<th style='width: 10%; text-align: center;'>강의 번호</th>\";\n");
      out.write("		            	htmlStr+=\"<th style='text-align: center;'>강의명</th>\";\n");
      out.write("		            	htmlStr+=\"<th style='width: 10%; text-align: center'>삭제</th>\";\n");
      out.write("		            	htmlStr+=\"</tr></thead>\";\n");
      out.write("		            	htmlStr+=\"<tbody>\";\n");
      out.write("					$.each(d.carr, function(key, val){ \n");
      out.write("		            	htmlStr+=\"<tr>\";\n");
      out.write("	            		htmlStr+=\"<td>\"+val.classnum+\"</td>\";\n");
      out.write("	            		htmlStr+=\"<td>\"+val.classname+\"</td>\";\n");
      out.write("	            		htmlStr+=\"<td style='text-align: center;'><a href='javascript:favoritedel(\"+val.favoritenum+\")'><img src='/Tutoring/img/delete.png' style='height:20px; width:20px;'></a></td>\";\n");
      out.write("						htmlStr+=\"</tr>\";\n");
      out.write("					})\n");
      out.write("						htmlStr+=\"</tbody></table>\";\n");
      out.write("						$(\".back2\").html(htmlStr);\n");
      out.write("				}\n");
      out.write("	)\n");
      out.write("})\n");
      out.write("//장바구니 삭제함수\n");
      out.write("function favoritedel(favoritenum){\n");
      out.write("	if(confirm(\"장바구니에서 삭제하시겠습니까?\")){\n");
      out.write("		$.getJSON(\"/Tutoring/member/favoriteDelete\", \n");
      out.write("				{\"favoritenum\":favoritenum, userid:$(\"#userid\").val()}, \n");
      out.write("				function(d){\n");
      out.write("						var htmlStr=\"<table class='table table-hover table-bordered table-sm'>\";\n");
      out.write("						htmlStr+=\"<thead><tr>\";\n");
      out.write("		            	htmlStr+=\"<th style='width: 10%; text-align: center;'>강의 번호</th>\";\n");
      ...
      out.write("<br/>\n");
      out.write("<h5 style=\"text-align: left\"><span id=\"cntSpan\">장바구니</span></h5>\n");
      out.write("<form action=\"/Tutoring/member/favoriteList\">\n");
